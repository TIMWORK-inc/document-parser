...
# 새로 만든 Logger 시스템 import
from Logger import LayoutDetectionLogger

class DocBankAdapter:
    def __init__(self):
        LayoutDetectionLogger.info("DocBankAdapter 초기화 시작")
        config = Config.DOCBANK
        ...
        LayoutDetectionLogger.info("DocBankAdapter 초기화 완료")
